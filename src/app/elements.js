export function getElements() {
  return {
    ...
    jumpSettingsBtn: document.getElementById("jumpSettingsBtn"),
    quickCaptureBtn: document.getElementById("quickCaptureBtn"),
    editorPanel: document.querySelector(".editor-panel"),
    settingsPanel: document.querySelector(".settings-panel"),
    captureSettingsSection: document.getElementById("captureSettingsSection"),
    editorStack: document.querySelector(".editor-stack"),
    editorPostTab: document.getElementById("editorPostTab"),
    editorMediaTab: document.getElementById("editorMediaTab"),
    editorReplyTab: document.getElementById("editorReplyTab"),
