  ...
  <style>
    ...
    * {
    ...
    .shared-card .author-name {
      font-size: ${uiRem(0.94)};
    }

    .shared .author-handle,
    .shared-card .author-handle {
      font-size: ${uiRem(0.81)};
    }

    .shared .tweet-text,
    .shared-card .tweet-text {
      margin-top: 10px;
      font-size: ${bodyRem(0.95)};
    }

    .shared .meta,
    .shared-card .meta {
      margin-top: 8px;
      font-size: ${uiRem(0.76)};
    }
